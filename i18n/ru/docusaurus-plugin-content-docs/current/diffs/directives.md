...
- **TARGET_PLATFORM** - содержит в себе название целевой платформы, например "win-64", тип ***string***;
- **CURRENT_PLATFORM** - содержит в себе название текущей платформы, например "linux-64", тип ***string***;
